...
var formatForDownload = function(){
  ...
  results.push("<style>body{font-family:calibri;font-size:16px;display:block;margin-left:10px;}img{max-width:2000px;}#hr,#nucleotidefreq img{border-style:solid;border-color:#d3d6db}.hide,.monospace{display:none}#codonfreq1 img:hover,#codonfreq2 img:hover,#codonfreq3 img:hover{cursor:zoom-in}#nucleotidefreq img{background-color:#fff;border-width:2px}#codonfreq1 img,#codonfreq2 img,#codonfreq3 img{position:relative;left:-10px;background-color:#fff;border-color:#d3d6db;border-style:solid;border-width:2px}#hr{margin-top:5px;margin-bottom:5px;border-width:1px}.hidebutton,.showbutton{background-color:#3c579d;color:#fff;width:50px;border:none;margin-bottom:10px;margin-top:10px}.break-word{word-wrap:break-word}.resulttitle{font-weight:700;margin-top:5px;margin-bottom:5px}.monospace{font-family:monospace;font-size:13px;padding-left:60px}#cpgislands,#formattedseq,#molweightDNA,#nucleotidefreq,#reverse-complement,#shorttranslatedseq1,#shorttranslatedseq2,#shorttranslatedseq3{border-bottom-style:solid;border-width:1px}#cpgislandsspan,#formattedseqspan,#molweightDNAspan,#nucleotidefreqspan,#reverse-complementspan,#shorttranslatedseq1span,#shorttranslatedseq2span,#shorttranslatedseq3span{padding-bottom:20px}</style>");
  //Add results
